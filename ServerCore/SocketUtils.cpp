...
bool SocketUtils::SetRecvBuferSize(SOCKET socket, int32 size)
{
...
{
	return SOCKET_ERROR != ::bind(socket, reinterpret_cast<const SOCKADDR*>(&netAddr.GetSockAddr()), size32(SOCKADDR_IN));
}
